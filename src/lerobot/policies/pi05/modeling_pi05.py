        ...
        **kwargs: Unpack[ActionSelectKwargs],
        ...
        if eval_frame:
            if cfg.grad_score_method == "vla_cache":
                ...
                score_tokens = aggregate_prefix_text_attention_scores(metas, masks, prefix_attentions)
                ...
                token_state.last_lang_tokens = tokens.detach().clone()
                token_state.last_lang_masks = masks.detach().clone()
